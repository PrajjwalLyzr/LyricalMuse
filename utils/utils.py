...
def template_end():
    with st.expander("ℹ️ - About this App"):
        st.markdown("This app uses Lyzr's Automata to generate original song lyrics tailored to their chosen mood, theme, genre, and any additional specifications.")
